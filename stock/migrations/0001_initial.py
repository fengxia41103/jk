    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('close_position', models.DecimalField(default=0.0, verbose_name='We closed at', max_digits=20, decimal_places=5)),
                ...
                ('gain', models.DecimalField(default=0.0, verbose_name='Gain', max_digits=20, decimal_places=5)),
                ('cost', models.DecimalField(default=0.0, verbose_name='Cost', max_digits=20, decimal_places=5)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('data_source', models.IntegerField(default=1, choices=[(1, b'S&P500'), (2, b'CI00*'), (3, b'WIND 8821*'), (4, b'China stock'), (5, b'WIND 2nd-tier sector')])),
                ('strategy', models.IntegerField(default=1, choices=[(1, b'S1 (by ranking)'), (2, b'S2 (buy low sell high)'), (3, b'S3 (buy high sell low)')])),
                ('strategy_value', models.IntegerField(default=1, verbose_name='Strategy value', choices=[(1, b'Daily return'), (2, b'Relative (H,L)'), (3, b'Relative Moving Avg')])),
                ...
                ('sector', models.ForeignKey(default=None, blank=True, to='stock.MySector', null=True, verbose_name='Data source sector')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_china_stock', models.BooleanField(default=False, verbose_name='Is a China stock')),
                ...
                ('last', models.DecimalField(default=0.0, verbose_name='Spot price', max_digits=20, decimal_places=5)),
                ('last_update_time', models.DateTimeField(auto_now=True, verbose_name='Spot sample time', null=True)),
                ('is_in_play', models.BooleanField(default=False, verbose_name='Has pending position')),
                ('prev_change', models.FloatField(default=0.0, verbose_name='Prev day change (%)')),
                ('day_change', models.FloatField(default=0.0, verbose_name='Today change(%)')),
                ('spread', models.DecimalField(default=0.0, verbose_name='Bid-ask spread', max_digits=20, decimal_places=5)),
                ('vol_over_float', models.FloatField(default=0.0, verbose_name='Vol/floating shares (%)')),
                ('week_adjusted_close', models.TextField(default=b'', verbose_name='1-week adjusted closing price')),
                ('month_adjusted_close', models.TextField(default=b'', verbose_name='1-month adjusted closing price')),
                ('fib_weekly_adjusted_close', models.TextField(default=b'', verbose_name='Fibonacci timezone adjusted closing price')),
                ('fib_daily_adjusted_close', models.TextField(default=b'', verbose_name='Fibonacci timezone adjusted closing price')),
                ('fib_weekly_score', models.FloatField(default=0, verbose_name='Weighed sum of weekly adj close price')),
                ('fib_daily_score', models.FloatField(default=0, verbose_name='Weighed sum of daily adj close price')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('open_price', models.DecimalField(verbose_name='Open', max_digits=20, decimal_places=5)),
                ('high_price', models.DecimalField(verbose_name='High', max_digits=20, decimal_places=5)),
                ('low_price', models.DecimalField(verbose_name='Low', max_digits=20, decimal_places=5)),
                ('close_price', models.DecimalField(verbose_name='Close', max_digits=20, decimal_places=5)),
                ('adj_open', models.DecimalField(default=-1, verbose_name='Adjusted open', max_digits=20, decimal_places=5)),
                ('adj_high', models.DecimalField(default=-1, verbose_name='Adjusted high', max_digits=20, decimal_places=5)),
                ('adj_low', models.DecimalField(default=-1, verbose_name='Adjusted low', max_digits=20, decimal_places=5)),
                ('adj_close', models.DecimalField(default=-1, verbose_name='Adjusted close', max_digits=20, decimal_places=5)),
                ('adj_factor', models.FloatField(default=0, verbose_name='Adjustment factor')),
                ('amount', models.FloatField(default=-1, verbose_name='\u6210\u4ea4\u91d1\u989d (000)')),
                ('vol', models.FloatField(verbose_name='Volume (000)')),
                ('flag_by_strategy', models.CharField(default=b'U', max_length=1, null=True, verbose_name='Back testing flag', blank=True)),
                ('val_by_strategy', models.FloatField(default=0.0, null=True, verbose_name='Computed value based on a strategy', blank=True)),
                ('peer_rank', models.IntegerField(default=0, null=True, verbose_name='Ranking among peers', blank=True)),
                ('status', models.IntegerField(default=-1, verbose_name='Stock trading status, eg. stopped trading on that day')),
                ('daily_return', models.FloatField(default=None, null=True, verbose_name="(Today's close - Today's Open)/Today's Open*100", blank=True)),
                ('overnight_return', models.FloatField(default=None, null=True, verbose_name="(Today's adj close - Yesterday's adj close)/Yesterday's adj close*100", blank=True)),
                ('relative_hl', models.FloatField(default=None, null=True, verbose_name='Relative Position (H,L)', blank=True)),
                ('relative_ma', models.FloatField(default=None, null=True, verbose_name='Relative Position Moving Average', blank=True)),
                ('lg_slope', models.FloatField(default=None, null=True, verbose_name='Linear regression slope', blank=True)),
                ('si', models.FloatField(default=None, null=True, verbose_name='SI indicator', blank=True)),
                ('cci', models.FloatField(default=None, null=True, verbose_name='CCI indicator', blank=True)),
                ('decycler_oscillator', models.FloatField(default=None, null=True, verbose_name='Decycler oscillator', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('per_trade_total', models.DecimalField(default=1000.0, verbose_name='Per trade dollar amount', max_digits=20, decimal_places=5)),
